    ...
    def test(self):
        ...
        while True:
            ...
            if not os.path.exists(frame_path):
                break
            sharp1 = ImageSharpnessTool(cv2.imread(frame_path + os.path.sep + '00001.jpg'))
            sharp6 = ImageSharpnessTool(cv2.imread(frame_path + os.path.sep + '00006.jpg'))
            sharp11 = ImageSharpnessTool(cv2.imread(frame_path + os.path.sep + '00011.jpg'))
