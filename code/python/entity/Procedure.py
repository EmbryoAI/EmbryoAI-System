...
class Procedure(db.Model, mixin):
    ...
    cycleTypeId = db.Column(
        "cycle_type_id", db.String(32), default="f37b4a8a6bed11e8b4910242ac110002"
    )
    ...
    insemiTypeId = db.Column(
        "insemi_type_id", db.String(32), default="f37b46026bed11e8b4910242ac110002"
    )
