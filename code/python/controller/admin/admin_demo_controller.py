...
admin_demo_controller = Blueprint('admin_demo_controller', __name__)
url_prefix = '/admin/demo'
...
'''分页查询数据'''
@admin_demo_controller.route('/list/', methods=['GET'])
def list():
...
''' 跳转到添加页面 '''
@admin_demo_controller.route('/toSave/', methods=['GET'])
def toAdd():
    return render_template('admin/demo/add.html')
