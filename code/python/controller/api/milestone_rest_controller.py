...
def getMilestoneByEmbryoId(embryoId):
    logUtils.info('milestone_rest_controller.getMilestoneByEmbryoId-根据胚胎ID、和序列 查询出里程碑相关信息')
...
def getMilepostNode(embryoId,milestoneTime,upOrdown):
    logUtils.info('milestone_rest_controller.getMilepostNode-根据胚胎ID 和 当前时间序列 获取上下里程碑节点ID')
